...
const SearchBar = (props) => {
    ...
    return (
        <Navbar className="navbar" >
            ...
            <div>
                <Link className="navbutton" to="/order">
            ...
            <div><Link className='navbutton' to='/login'>Iniciar Sesion</Link></div>
            <div><Link className='navbutton' to='/signin'>Registrarse</Link></div>
            <div>
                <NavDropdown title={
